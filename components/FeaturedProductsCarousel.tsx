            ...
            >
              <article className="group h-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#0a1020] shadow-[0_14px_30px_rgba(0,0,0,0.28)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.34)]">
                ...
                <div className="space-y-3 p-5 text-center">
                  <Link href={item.href} className="block">
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#f3c74d] sm:text-[11px] sm:tracking-[0.24em]">
                      {item.category}
                    </p>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div className="flex flex-wrap justify-end gap-2">
                      <Link
                        href={item.href}
                        className="rounded-full border border-white/10 px-3 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-white transition hover:border-[#f3c74d]/45 hover:bg-white/10 sm:py-1 sm:text-[10px] sm:tracking-[0.2em]"
                      >
                        View details
                      </Link>
                      <AddToCartButton
                        ...
                        className="rounded-full bg-[#f3c74d] px-3 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#050b16] transition hover:bg-[#e4b935] sm:py-1 sm:text-[10px] sm:tracking-[0.2em]"
                      >
                        Order Now
                      </AddToCartButton>
                    </div>
