      ...
      <main className="mx-auto max-w-6xl px-4 py-10 md:px-8 md:py-14">
        <section className="grid overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a1020] shadow-[0_20px_60px_rgba(0,0,0,0.22)] lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6 px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16">
            <p className="text-xs uppercase tracking-[0.35em] text-[#f3c74d]">Desktop collection</p>
            <h1 className="font-display text-4xl font-bold leading-tight text-white md:text-5xl">
              {displayName} systems for business performance.
            </h1>
            <p className="max-w-2xl text-lg leading-7 text-slate-300">
              Browse enterprise-ready {displayName} desktop systems for teams that need consistent performance, clean deployment,
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/desktops" className="rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:border-[#f3c74d]/45 hover:bg-white/10">
                Back to brands
              </Link>
            </div>
          </div>
          ...
          <div className="relative min-h-[320px] bg-[linear-gradient(180deg,#0b1d3b_0%,#12386a_100%)]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 text-white md:p-10">
              <p className="text-xs uppercase tracking-[0.35em] text-white/75">Selection</p>
              <h2 className="mt-2 font-display text-3xl font-bold md:text-4xl">Reliable {displayName} setups.</h2>
            </div>
          </div>
        </section>
        ...
        <section className="mt-14">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-white/55">Models</p>
              <h2 className="font-display text-3xl font-semibold text-white">Choose the right {displayName} desktop.</h2>
            </div>
          </div>
          ...
          {products.length > 0 ? (
            ...
            <div className="rounded-[2rem] border border-dashed border-white/15 bg-[#0a1020] p-12 text-center">
              <p className="text-slate-400">No {displayName} desktops are currently listed.</p>
              <Link href="/desktops" className="mt-4 inline-block text-[#f3c74d] hover:underline">
                View other brands
              </Link>
            </div>
          )}
