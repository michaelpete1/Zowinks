      ...
      <main className="mx-auto max-w-6xl px-4 py-10 md:px-8 md:py-14">
        <section className="grid overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a1020] shadow-[0_20px_60px_rgba(0,0,0,0.22)] lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6 px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16">
            <p className="text-xs uppercase tracking-[0.35em] text-emerald-700">Dell collection</p>
            <h1 className="font-display text-4xl font-bold leading-tight md:text-5xl">
              Dell laptops for dependable business use.
            </h1>
            <p className="max-w-2xl text-lg leading-7 text-slate-600">
              Latitude and Precision systems for teams that need stable performance, practical hardware,
              and a straightforward procurement path.
            </p>
          ...
          <div className="relative min-h-[320px] bg-[linear-gradient(180deg,#12386a_0%,#1d4f93_100%)]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 text-white md:p-10">
              ...
              <h2 className="mt-2 font-display text-3xl font-bold md:text-4xl">Latitude and Precision lines.</h2>
            </div>
          </div>
        </section>
        ...
        <section className="mt-14">
          <div className="mb-8">
            ...
            <h2 className="mt-2 font-display text-3xl font-semibold text-slate-900">Dell options for everyday work.</h2>
          </div>
