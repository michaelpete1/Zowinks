      ...
      <main className="mx-auto max-w-6xl px-4 py-10 md:px-8 md:py-14">
        <section className="grid overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)] lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6 px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16">
            <p className="text-xs uppercase tracking-[0.35em] text-emerald-700">MacBook collection</p>
            <h1 className="font-display text-4xl font-bold leading-tight md:text-5xl">
              MacBook models for premium mobile work.
            </h1>
            <p className="max-w-2xl text-lg leading-7 text-slate-600">
              Browse MacBook Air and Pro systems for teams that need strong battery life, clean design, and
          ...
          <div className="relative min-h-[320px] bg-[linear-gradient(180deg,#12386a_0%,#1d4f93_100%)]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 text-white md:p-10">
              ...
              <h2 className="mt-2 font-display text-3xl font-bold md:text-4xl">MacBook Air and Pro lines.</h2>
            </div>
          </div>
        </section>
        ...
        <section className="mt-14">
          <div className="mb-8">
            ...
            <h2 className="mt-2 font-display text-3xl font-semibold text-slate-900">MacBook options for modern teams.</h2>
          </div>
