        ...
        <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)] lg:p-10">
          ...
          <div className="space-y-6 p-8 lg:p-0 lg:pt-8">
            ...
            <p className="max-w-md text-sm leading-6 text-slate-600 md:text-base">
              This page is separate from sign in so the flow stays focused. Use
              it when the backend team has approved a new admin user.
            </p>
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.10)] md:p-10">
          ...
          >
            <input
              ...
              className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-sky-500 focus:bg-white"
            />
            <input
            ...
            <input
              ...
              className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-sky-500 focus:bg-white md:col-span-2"
            />
            <input
            ...
            <button
              type="submit"
              disabled={creating}
              className="rounded-2xl bg-slate-950 px-6 py-3.5 text-sm font-bold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60 md:col-span-2"
            >
