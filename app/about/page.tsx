      ...
      <main className="mx-auto max-w-7xl px-4 py-8 md:px-8 md:py-12">
        <section className="overflow-hidden rounded-[2.25rem] bg-[#0a1020] shadow-[0_24px_80px_rgba(0,0,0,0.24)] ring-1 ring-white/10">
          <div className="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="relative space-y-6">
                ...
                <div className="grid gap-3 pt-3 sm:grid-cols-3">
                  <div className="rounded-[1.25rem] bg-white/10 px-4 py-4 backdrop-blur-sm">
                    <p className="text-[11px] uppercase tracking-[0.24em] text-cyan-100">Focus</p>
                    <p className="mt-1 text-sm font-semibold">Office-ready hardware</p>
                  </div>
                  <div className="rounded-[1.25rem] bg-white/10 px-4 py-4 backdrop-blur-sm">
            ...
            <div className="grid gap-0 bg-slate-50 p-4 md:p-6">
              <div className="relative min-h-[260px] overflow-hidden rounded-[1.8rem] bg-slate-200 md:min-h-[320px]">
                <Image
                  src="/desktop.jpg"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 text-white md:p-6">
                  <p className="text-[11px] uppercase tracking-[0.28em] text-cyan-100">Company focus</p>
                  <h2 className="mt-2 font-display text-2xl font-bold md:text-3xl">Reliable hardware. Clear support.</h2>
                  <p className="mt-2 max-w-md text-sm leading-6 text-slate-100/90">
                    Teams need procurement that is predictable. We keep the buying process direct so projects move
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div className="overflow-hidden rounded-[1.4rem] bg-white shadow-[0_12px_28px_rgba(15,23,42,0.06)]">
                  ...
                  <div className="p-4">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">Business laptops suited for teams that need dependable daily performance.</p>
                  </div>
                </div>
                <div className="overflow-hidden rounded-[1.4rem] bg-white shadow-[0_12px_28px_rgba(15,23,42,0.06)]">
                  <div className="relative h-44">
                  ...
                  <div className="p-4">
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">Reliable supply options for offices, departments, and larger rollouts.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mt-12 grid gap-6 lg:grid-cols-3">
          {principles.map((item, index) => (
            <article key={item.title} className="rounded-[1.75rem] bg-white p-6 shadow-[0_14px_32px_rgba(15,23,42,0.06)] ring-1 ring-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Principle</p>
